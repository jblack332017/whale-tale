...
python whale-tale.py augrotsub-no-.csv input-sans-new-whale augmented-correct-rotation > augrot-no-new-whale.log
...
#python whale-tale.py auglargesub.csv input augmented-correct-large > auglarge.log
