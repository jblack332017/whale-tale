#python whale-tale.py smallsub.csv small > small.log
...
#python whale-tale.py augrotsub.csv input-sans-new-whale augmented-correct-rotation > augrot.log
...
python whale-tale.py auglargesub.csv input-sans-new-whale augmented-correct-large > auglarge.log
